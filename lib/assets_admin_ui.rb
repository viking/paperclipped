        ...
        def load_default_asset_regions
          returning OpenStruct.new do |asset|
            asset.edit = Radiant::AdminUI::RegionSet.new do |edit|
              edit.main.concat %w{edit_header edit_form edit_regenerate} # assets_container
            ...
            asset.index = Radiant::AdminUI::RegionSet.new do |index|
              ...
              index.thead.concat %w{thumbnail_header title_header link_header content_type_header modify_header}
              index.tbody.concat %w{thumbnail_cell title_cell link_cell content_type_cell remove_cell} # bucket_cell
